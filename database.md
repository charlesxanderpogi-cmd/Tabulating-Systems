...
CREATE TABLE public.judge_message (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  event_id bigint NOT NULL,
  judge_id bigint,
  title text,
...
CREATE TABLE public.judge_message_seen (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  message_id bigint NOT NULL,
  judge_id bigint NOT NULL,
  seen_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT judge_message_seen_pkey PRIMARY KEY (id),
  CONSTRAINT judge_message_seen_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.judge_message(id),
  CONSTRAINT judge_message_seen_judge_id_fkey FOREIGN KEY (judge_id) REFERENCES public.user_judge(id)
);
...
CREATE TABLE public.tabulator_signature (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  tabulator_id bigint NOT NULL,
  event_id bigint NOT NULL,
  title text NOT NULL,
  name text NOT NULL,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT tabulator_signature_pkey PRIMARY KEY (id),
  CONSTRAINT tabulator_signature_tabulator_fkey FOREIGN KEY (tabulator_id) REFERENCES public.user_tabulator(id),
  CONSTRAINT tabulator_signature_event_fkey FOREIGN KEY (event_id) REFERENCES public.event(id)
);
